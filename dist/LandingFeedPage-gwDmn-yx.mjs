import { bC as L, aD as x, a7 as C, a6 as p, t as A, bD as v, bE as N, bF as S, aC as w, ao as P } from "./index-l0e33MFh.mjs";
import { useState as f, useEffect as j } from "react";
import { N as Q } from "./NoImgFound-8bVP7rb5.mjs";
import { f as V, F as T } from "./Dashboard-qQTJ__dD.mjs";
import { N as I } from "./NoEventAvaliable-vBaWXttD.mjs";
import { P as X, R as K } from "./ReadMoreReadLess-YOQMYnx9.mjs";
import "react-dom";
      ...
      return /* @__PURE__ */ A.jsx(A.Fragment, { children: /* @__PURE__ */ A.jsxs("div", { className: "CarouselCard", children: [
        ...
        e.map((b) => {
          let m = b.startTime, E = C(m * 1e3).format(
            "hh:mm A"
          ), D = b.endTime, W = C(D).format("h:mm a");
