import { aD as w, t as e, ar as N, bH as L, a6 as m, bn as X, a7 as b } from "./index-l0e33MFh.mjs";
import { useRef as y, useState as i, useEffect as O } from "react";
import { a as z } from "./index.esm-97u0BfT4.mjs";
import { T, F as P } from "./Dashboard-qQTJ__dD.mjs";
import "react-dom";
...
const v = "data:image/png;base64,", k = "data:image/png;base64,", U = () => {
  ...
  const [r, l] = i(!1), [x, t] = i(!1), [g, n] = i(!1), [d, u] = i(!1), p = w(), [I, F] = i(!1), B = () => {
    n(!0), setTimeout(() => {
      var A, a, c, h, D, f, C;
      if ((A = o.current) != null && A.value ? (a = o.current) != null && a.value && (l(!1), u(!1)) : (l(!0), u(!1)), (c = s.current) != null && c.value ? (h = s.current) != null && h.value && t(!1) : t(!0), (D = o.current) != null && D.value && ((f = s.current) != null && f.value)) {
        let S = {
    ...
    /* @__PURE__ */ e.jsxs("div", { className: "MazjidAnnoucementMainContainer", children: [
      ...
      /* @__PURE__ */ e.jsx(
        N,
        {
          ...
          autoComplete: "Off",
          error: r,
          helperText: r ? "Please Fill The title" : " ",
          label: "Title",
          onChange: (A) => {
            var a, c;
            r && ((a = o.current) != null && a.value ? (c = o.current) != null && c.value && l(!1) : l(!0));
          },
          size: "small",
          sx: {
            "& .MuiTextField-root": {
  ...
  const o = X(), [s, r] = i([]), [l, x] = i(/* @__PURE__ */ new Date()), [t, g] = i(!1);
  return O(() => {
    l && o(P()).then((d) => {
      d.success ? r(d.data.data) : m(
        !0,
        "error",
  ...
  }, [l]), /* @__PURE__ */ e.jsx(e.Fragment, { children: /* @__PURE__ */ e.jsxs("div", { className: "AnnounceHistoryContianer", children: [
